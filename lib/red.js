...
Red.prototype.move = function() {
  ...
  if (dist < 10) {
    ...
    // WOW <audio> is super lame!
    //this.game.audio.volume = clamp(Math.abs(dist - 10) / 10, 0, 1);
    /*if (this.game.audio.paused === true) {
      if (window.chrome) this.game.audio.load();
      this.game.audio.volume = 0.5;
    ...
    /*if (this.game.audio.paused === false) {
